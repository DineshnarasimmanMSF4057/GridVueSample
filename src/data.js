...
exports.pizzaData = exports.createDetailSalesData = exports.detailSalesData = exports.createDetailEmployeeData = exports.detailEmployeeData = exports.getTradeData = exports.hierarchyOrderdata = exports.data1 = exports.orderDataSource = exports.employeeDetails = exports.orderDetails = exports.columnSpanData = exports.employeeData = exports.inventoryData = exports.data = exports.customerData = exports.categoryData = exports.orderData = exports.orderDatas = exports.taskDetail = exports.employeeDetail = exports.OverallData = exports.energyData = void 0;
...
function createDetailEmployeeData() {
    if (exports.detailEmployeeData.length) {
        return;
    }
    ...
    for (var i = 0; i < 20000; i++) {
        ...
        var email = "".concat(firstName.toLowerCase(), ".").concat(lastName.toLowerCase(), "@sales.com");
        var reportingPerson = ReportingPerson[Math.floor(Math.random() * ReportingPerson.length)];
        var currentDate = new Date();
        exports.detailEmployeeData.push({
        ...
        for (var j = 0; j < 3; j++) {
            ...
            exports.detailEmployeeData[i].Meetings.push({
                Id: j,
                Subject: "Meeting with ".concat(customerNames[customerIndex], "."),
                StartTime: startDate,
                EndTime: endDate,
...
exports.createDetailEmployeeData = createDetailEmployeeData;
exports.detailSalesData = [];
...
function createDetailSalesData() {
    if (exports.detailSalesData.length) {
        return;
    }
...
exports.createDetailSalesData = createDetailSalesData;
exports.pizzaData = [
    {
        "Id": 1,
